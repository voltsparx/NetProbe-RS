...
const SCAN_TYPES: &[ScanTypeEntry] = &[
    ...
    ScanTypeEntry {
        ...
        category: "hybrid",
        status: ScanTypeStatus::Implemented,
        flags: &["--hybrid", "--hybrid-scan", "--masscan-hybrid", "--controlled-firehose", "-sHY"],
    ...
    ScanTypeEntry {
        ...
        category: "tbns",
        status: ScanTypeStatus::Implemented,
        flags: &["--phantom", "--phantom-scan", "--device-check", "-sPH"],
    ...
    ScanTypeEntry {
        ...
        category: "tbns",
        status: ScanTypeStatus::Implemented,
        flags: &["--kis", "--kis-scan", "--kinetic-impedance-scan", "-sKI"],
    ...
    ScanTypeEntry {
        ...
        category: "tbns",
        status: ScanTypeStatus::Implemented,
        flags: &["--sar", "--sar-scan", "--sars", "--spectral-adaptive-response", "-sSR"],
    ...
    ScanTypeEntry {
        ...
        category: "defensive",
        status: ScanTypeStatus::Implemented,
        flags: &["--idf", "--idf-scan", "--dummy-scan", "--fog-scan", "--inert-decoy-fog", "-sID"],
    ...
    ScanTypeEntry {
        ...
        category: "defensive",
        status: ScanTypeStatus::Implemented,
        flags: &["--mirror", "--mirror-scan", "--reflective-hybrid", "-sMR"],
    ...
    ScanTypeEntry {
        ...
        category: "defensive",
        status: ScanTypeStatus::Implemented,
        flags: &["--callback-ping", "--callback", "--cb-ping", "--mesh-callback", "-sCB"],
